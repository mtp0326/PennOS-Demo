...
\DoxyCodeLine{00039\ \textcolor{comment}{//\ Make\ sure\ that\ the\ calling\ thread\ cannot\ be\ suspended\ before\ calling\ these}}
\DoxyCodeLine{00040\ \textcolor{comment}{//\ functions.\ Exceptions\ to\ this\ are\ spthread\_exit(),\ spthread\_self()\ and\ if\ a}}
\DoxyCodeLine{00041\ \textcolor{comment}{//\ thread\ is\ continuing\ or\ suspending\ itself.}}
\DoxyCodeLine{00042\ \textcolor{comment}{//\ spthread\_create:}}
\DoxyCodeLine{00043\ \textcolor{comment}{//\ this\ function\ works\ similar\ to\ pthread\_create,\ except\ for\ two\ differences.}}
\DoxyCodeLine{00044\ \textcolor{comment}{//\ 1)\ the\ created\ pthread\ is\ able\ to\ be\ asychronously\ suspended,\ and\ continued}}
\DoxyCodeLine{00045\ \textcolor{comment}{//\ \ \ \ using\ the\ functions:}}
\DoxyCodeLine{00046\ \textcolor{comment}{//\ \ \ \ \ \ -\/\ spthread\_suspend}}
\DoxyCodeLine{00047\ \textcolor{comment}{//\ \ \ \ \ \ -\/\ spthread\_continue}}
\DoxyCodeLine{00048\ \textcolor{comment}{//\ 2)\ The\ created\ pthread\ will\ be\ suspended\ before\ it\ executes\ the\ specified}}
\DoxyCodeLine{00049\ \textcolor{comment}{//\ \ \ \ routine.\ It\ must\ first\ be\ continued\ with\ \`{}spthread\_continue`\ before}}
\DoxyCodeLine{00050\ \textcolor{comment}{//\ \ \ \ it\ will\ start\ executing.}}
\DoxyCodeLine{00051\ \textcolor{comment}{//}}
\DoxyCodeLine{00052\ \textcolor{comment}{//\ It\ is\ worth\ noting\ that\ this\ function\ is\ not\ signal\ safe.}}
\DoxyCodeLine{00053\ \textcolor{comment}{//\ In\ other\ words,\ it\ should\ not\ be\ called\ from\ a\ signal\ handler.}}
\DoxyCodeLine{00054\ \textcolor{comment}{//}}
\DoxyCodeLine{00055\ \textcolor{comment}{//\ to\ avoid\ repetition,\ see\ pthread\_create(3)\ for\ details}}
\DoxyCodeLine{00056\ \textcolor{comment}{//\ on\ arguments\ and\ return\ values\ as\ they\ are\ the\ same\ here.}}
\DoxyCodeLine{00057\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{spthread_8h_a81f1d35d233df959fe1af49ff4ace0e5}{spthread\_create}}(\mbox{\hyperlink{structspthread__st}{spthread\_t}}*\ thread,}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ pthread\_attr\_t*\ attr,}
\DoxyCodeLine{00059\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{void}*\ (*start\_routine)(\textcolor{keywordtype}{void}*),}
\DoxyCodeLine{00060\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{void}*\ arg);}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \textcolor{comment}{//\ The\ spthread\_suspend\ function\ will\ signal\ to\ the}}
\DoxyCodeLine{00063\ \textcolor{comment}{//\ specified\ thread\ to\ suspend\ execution.}}
\DoxyCodeLine{00064\ \textcolor{comment}{//}}
\DoxyCodeLine{00065\ \textcolor{comment}{//\ Calling\ spthread\_suspend\ on\ an\ already\ suspended}}
\DoxyCodeLine{00066\ \textcolor{comment}{//\ thread\ does\ not\ do\ anything.}}
\DoxyCodeLine{00067\ \textcolor{comment}{//}}
\DoxyCodeLine{00068\ \textcolor{comment}{//\ It\ is\ worth\ noting\ that\ this\ function\ is\ not\ signal\ safe.}}
\DoxyCodeLine{00069\ \textcolor{comment}{//\ In\ other\ words,\ it\ should\ not\ be\ called\ from\ a\ signal\ handler.}}
\DoxyCodeLine{00070\ \textcolor{comment}{//}}
\DoxyCodeLine{00071\ \textcolor{comment}{//\ args:}}
\DoxyCodeLine{00072\ \textcolor{comment}{//\ -\/\ pthread\_t\ thread:\ the\ thread\ we\ want\ to\ suspend}}
\DoxyCodeLine{00073\ \textcolor{comment}{//\ \ \ This\ thread\ must\ be\ created\ using\ the\ spthread\_create()\ function,}}
\DoxyCodeLine{00074\ \textcolor{comment}{//\ \ \ if\ created\ by\ some\ other\ function,\ the\ behaviour\ is\ undefined.}}
