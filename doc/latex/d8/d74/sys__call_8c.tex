...
pid\+\_\+t \mbox{\hyperlink{sys__call_8c_ac2ec784264fde0c203b00c563600c259}{s\+\_\+spawn\+\_\+priority}} (void \texorpdfstring{$\ast$}{*}(\texorpdfstring{$\ast$}{*}func)(void \texorpdfstring{$\ast$}{*}), char \texorpdfstring{$\ast$}{*}argv\mbox{[}$\,$\mbox{]}, int fd0, int fd1, unsigned int \mbox{\hyperlink{pennos_8c_a2e0cca4a43c21259b881d59c96c74fe0}{priority}})
\item 
...
\end{DoxyReturn}
\Hypertarget{sys__call_8c_ac2ec784264fde0c203b00c563600c259}\label{sys__call_8c_ac2ec784264fde0c203b00c563600c259} 
\index{sys\_call.c@{sys\_call.c}!s\_spawn\_priority@{s\_spawn\_priority}}
\index{s\_spawn\_priority@{s\_spawn\_priority}!sys\_call.c@{sys\_call.c}}
\doxysubsubsection{\texorpdfstring{s\_spawn\_priority()}{s\_spawn\_priority()}}
{\footnotesize\ttfamily pid\+\_\+t s\+\_\+spawn\+\_\+priority (\begin{DoxyParamCaption}\item[{void \texorpdfstring{$\ast$}{*}(\texorpdfstring{$\ast$}{*})(void \texorpdfstring{$\ast$}{*})}]{func,  }\item[{char \texorpdfstring{$\ast$}{*}}]{argv\mbox{[}$\,$\mbox{]},  }\item[{int}]{fd0,  }\item[{int}]{fd1,  }\item[{unsigned int}]{priority }\end{DoxyParamCaption})}
