...
, \mbox{\hyperlink{sys__call_8h_a9df1ce5034a7614c2c55bc05500f5991a49959dd441dcda75d6898cf2c68fb374}{CONTINUE}}
 \}
\begin{DoxyCompactList}\small\item\em This is an enum used to specify which log message should be added for \doxylink{sys__call_8c_a1db57eb907f680ab844066357b793d5f}{s\+\_\+write\+\_\+log}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
pid\+\_\+t \mbox{\hyperlink{sys__call_8h_a3c0c6c4ae69799354d707ff57ac925d3}{s\+\_\+waitpid}} (pid\+\_\+t pid, int \texorpdfstring{$\ast$}{*}wstatus, bool \mbox{\hyperlink{stress_8c_aaacb1f06dd4ec309398fb76d008fdc90}{nohang}})
...
int \mbox{\hyperlink{sys__call_8h_ac6d9cddaea840f87aee45bd6e6122acc}{s\+\_\+resume\+\_\+block}} (pid\+\_\+t pid)
\begin{DoxyCompactList}\small\item\em Blocks process with command "{}sleep"{} that has been stopped before. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{sys__call_8h_a964c6f7d6a06dddfd15cbd2d348dbd59}{s\+\_\+reap\+\_\+all\+\_\+child}} (\mbox{\hyperlink{structpcb__t}{pcb\+\_\+t}} \texorpdfstring{$\ast$}{*}parent)
...
int \mbox{\hyperlink{sys__call_8h_a0b8fdff50e5b9c5fa8559fe294e4243f}{s\+\_\+sleep}} (unsigned int ticks)
...
int \mbox{\hyperlink{sys__call_8h_a1a3aeae7e3fb489c4cf3c4dc3911bbce}{s\+\_\+busy}} (void)
...
\begin{DoxyCompactList}\small\item\em Spawns and waits for a process, combining s\+\_\+spawn and s\+\_\+waitpid. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Returns the function that was specified through string. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Prints information to log.\+txt for each movement of each processor/thread. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Find the list that the processor belongs to, removes it from that list, and adds it to the specified list in argument. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_abf654a2582830ad3a5ce3db38c944f81}{s\+\_\+zombie}} (pid\+\_\+t pid)
\begin{DoxyCompactList}\small\item\em Makes the specified processor a zombie, orpanifies all its child processors, then reaps all children. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a31e11484cfd56821c3e9a1fa43aafcf0}{s\+\_\+fg}} (\mbox{\hyperlink{structpcb__t}{pcb\+\_\+t}} \texorpdfstring{$\ast$}{*}proc)
\begin{DoxyCompactList}\small\item\em If pid is specified, fg looks for processor with the pid. If no specified pid, fg looks in order of stopped and background, then the processor with the highest job id. Fg then gives the processor terminal control. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a3dd0bc17589ba38590b19d8256ffee4f}{s\+\_\+bg\+\_\+wait}} (\mbox{\hyperlink{structpcb__t}{pcb\+\_\+t}} \texorpdfstring{$\ast$}{*}proc)
\begin{DoxyCompactList}\small\item\em Checks status of background processes with waitpid(nohang). \end{DoxyCompactList}\item 
\mbox{\hyperlink{structpcb__t}{pcb\+\_\+t}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{sys__call_8h_a6a3382896d35c17f052ccce317c40dc2}{find\+\_\+jobs\+\_\+proc}} (\mbox{\hyperlink{structCircularList}{Circular\+List}} \texorpdfstring{$\ast$}{*}list)
\begin{DoxyCompactList}\small\item\em Looks for the processor in stopped or background with the highest job id. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a2e87f593f5c2f59d7a90958b3e51751d}{s\+\_\+print\+\_\+process}} (\mbox{\hyperlink{structCircularList}{Circular\+List}} \texorpdfstring{$\ast$}{*}list)
\begin{DoxyCompactList}\small\item\em Prints all processes in processes, stopped, blocked, zombied. Used for \textquotesingle{}ps\textquotesingle{} command. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_adc34021a4da6a8e67a92d16e8adef872}{s\+\_\+print\+\_\+jobs}} ()
\begin{DoxyCompactList}\small\item\em Prints the list of processes in stopped or background list. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a941a4ccb62fb48fd5feb049c32df7fdd}{file\+\_\+errno\+\_\+helper}} (int ret)
\item 
...
\begin{DoxyCompactList}\small\item\em removes the file specified by {\ttfamily fname} , {\ttfamily fname} must exist, returns -\/1 on error if it doesn\textquotesingle{}t \end{DoxyCompactList}\item 
...
int \mbox{\hyperlink{sys__call_8h_a6f0dde68afa56241329a522dcf741dec}{s\+\_\+ls}} (const char \texorpdfstring{$\ast$}{*}filename, int fd)
...
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{sys__call_8h_a18b25be5ab040f60070ff9ea839648be}{s\+\_\+read\+\_\+all}} (const char \texorpdfstring{$\ast$}{*}filename, int \texorpdfstring{$\ast$}{*}read\+\_\+num)
\begin{DoxyCompactList}\small\item\em Wrapper function around k\+\_\+read\+\_\+all. \end{DoxyCompactList}\item 
char \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{sys__call_8h_a2638b24106c052e0a513643f712e8d00}{s\+\_\+get\+\_\+fname\+\_\+from\+\_\+fd}} (int fd)
\begin{DoxyCompactList}\small\item\em Wrapper function around k\+\_\+get\+\_\+fname\+\_\+from\+\_\+fd. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_ab40c873ca412b774e2fc1b59527538be}{s\+\_\+update\+\_\+timestamp}} (const char \texorpdfstring{$\ast$}{*}source)
\begin{DoxyCompactList}\small\item\em Wrapper function around k\+\_\+update\+\_\+timestamp. Returns the filename for the given file descriptor number. \end{DoxyCompactList}\item 
off\+\_\+t \mbox{\hyperlink{sys__call_8h_ae8b8546b3350e1602c1574b1b0cb58d0}{s\+\_\+does\+\_\+file\+\_\+exist2}} (const char \texorpdfstring{$\ast$}{*}fname)
\begin{DoxyCompactList}\small\item\em Wrapper function around k\+\_\+does\+\_\+file\+\_\+exst2. Change the timestamp of the file to the current time. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_aeea2dcf94b9a35c86a67cf6ec97fd21d}{s\+\_\+rename}} (const char \texorpdfstring{$\ast$}{*}source, const char \texorpdfstring{$\ast$}{*}dest)
\begin{DoxyCompactList}\small\item\em s-\/function wrapper around k\+\_\+rename, which renames {\ttfamily source} to {\ttfamily dest}. {\ttfamily source} must exist, if {\ttfamily dest} already exists, then it is deleted \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a92d71eb90d0b9786bec0302347f5a99f}{s\+\_\+change\+\_\+mode}} (const char \texorpdfstring{$\ast$}{*}change, const char \texorpdfstring{$\ast$}{*}filename)
\begin{DoxyCompactList}\small\item\em s-\/function wrapper around k\+\_\+change\+\_\+mode, which changes the mode (permission) of the file in the directory entry, specificed by {\ttfamily filename} with change {\ttfamily change}. Errors if the resulting permission is invalid or if {\ttfamily filename} doesn\textquotesingle{}t exist \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_ad55b8ad7785acad109a35a819e415622}{s\+\_\+cp\+\_\+within\+\_\+fat}} (char \texorpdfstring{$\ast$}{*}source, char \texorpdfstring{$\ast$}{*}dest)
\begin{DoxyCompactList}\small\item\em s-\/function wrapper around k\+\_\+cp\+\_\+within\+\_\+fat. Copies contents of {\ttfamily source} to {\ttfamily dest}. {\ttfamily source} must exist, if {\ttfamily dest} doesn\textquotesingle{}t exist then it is created. \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a494917a8ce36ad19470a2116e57a1bc3}{s\+\_\+cp\+\_\+to\+\_\+host}} (char \texorpdfstring{$\ast$}{*}source, char \texorpdfstring{$\ast$}{*}host\+\_\+dest)
\begin{DoxyCompactList}\small\item\em s-\/function wrapper around k\+\_\+cp\+\_\+to\+\_\+host \end{DoxyCompactList}\item 
int \mbox{\hyperlink{sys__call_8h_a1e2fd1371e1cd60d964afd80eb89943e}{s\+\_\+cp\+\_\+from\+\_\+host}} (char \texorpdfstring{$\ast$}{*}host\+\_\+source, char \texorpdfstring{$\ast$}{*}dest)
\begin{DoxyCompactList}\small\item\em s-\/function wrapper around k\+\_\+cp\+\_\+from\+\_\+host \end{DoxyCompactList}\end{DoxyCompactItemize}
...
This is an enum used to specify which log message should be added for \doxylink{sys__call_8c_a1db57eb907f680ab844066357b793d5f}{s\+\_\+write\+\_\+log}. 
...
\Hypertarget{sys__call_8h_a941a4ccb62fb48fd5feb049c32df7fdd}\label{sys__call_8h_a941a4ccb62fb48fd5feb049c32df7fdd} 
\index{sys\_call.h@{sys\_call.h}!file\_errno\_helper@{file\_errno\_helper}}
\index{file\_errno\_helper@{file\_errno\_helper}!sys\_call.h@{sys\_call.h}}
\doxysubsubsection{\texorpdfstring{file\_errno\_helper()}{file\_errno\_helper()}}
{\footnotesize\ttfamily int file\+\_\+errno\+\_\+helper (\begin{DoxyParamCaption}\item[{int}]{ret }\end{DoxyParamCaption})}

\Hypertarget{sys__call_8h_a6a3382896d35c17f052ccce317c40dc2}\label{sys__call_8h_a6a3382896d35c17f052ccce317c40dc2} 
\index{sys\_call.h@{sys\_call.h}!find\_jobs\_proc@{find\_jobs\_proc}}
\index{find\_jobs\_proc@{find\_jobs\_proc}!sys\_call.h@{sys\_call.h}}
\doxysubsubsection{\texorpdfstring{find\_jobs\_proc()}{find\_jobs\_proc()}}
{\footnotesize\ttfamily \mbox{\hyperlink{structpcb__t}{pcb\+\_\+t}} \texorpdfstring{$\ast$}{*} find\+\_\+jobs\+\_\+proc (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structCircularList}{Circular\+List}} \texorpdfstring{$\ast$}{*}}]{list }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a3dd0bc17589ba38590b19d8256ffee4f}\label{sys__call_8h_a3dd0bc17589ba38590b19d8256ffee4f} 
\index{sys\_call.h@{sys\_call.h}!s\_bg\_wait@{s\_bg\_wait}}
\index{s\_bg\_wait@{s\_bg\_wait}!sys\_call.h@{sys\_call.h}}
...
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a1a3aeae7e3fb489c4cf3c4dc3911bbce}\label{sys__call_8h_a1a3aeae7e3fb489c4cf3c4dc3911bbce} 
\index{sys\_call.h@{sys\_call.h}!s\_busy@{s\_busy}}
\index{s\_busy@{s\_busy}!sys\_call.h@{sys\_call.h}}
...
int Returns 0 on success, -\/1 on failure and sets errno. 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a92d71eb90d0b9786bec0302347f5a99f}\label{sys__call_8h_a92d71eb90d0b9786bec0302347f5a99f} 
\index{sys\_call.h@{sys\_call.h}!s\_change\_mode@{s\_change\_mode}}
\index{s\_change\_mode@{s\_change\_mode}!sys\_call.h@{sys\_call.h}}
...
s-\/function wrapper around k\+\_\+change\+\_\+mode, which changes the mode (permission) of the file in the directory entry, specificed by {\ttfamily filename} with change {\ttfamily change}. Errors if the resulting permission is invalid or if {\ttfamily filename} doesn\textquotesingle{}t exist 


\begin{DoxyParams}{Parameters}
{\em change} & the change to be made (e.\+g. -\/w, +w, -\/rw, etc) \\
\hline
{\em filename} & name of the specified file to be changed\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em fd} & file descriptor number to be closed\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int (-\/1 on error) 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a1e2fd1371e1cd60d964afd80eb89943e}\label{sys__call_8h_a1e2fd1371e1cd60d964afd80eb89943e} 
\index{sys\_call.h@{sys\_call.h}!s\_cp\_from\_host@{s\_cp\_from\_host}}
\index{s\_cp\_from\_host@{s\_cp\_from\_host}!sys\_call.h@{sys\_call.h}}
...
s-\/function wrapper around k\+\_\+cp\+\_\+from\+\_\+host 


\begin{DoxyParams}{Parameters}
{\em host\+\_\+source} & source filename to copy from (on host device) \\
\hline
{\em dest} & destination filename to copy into (in Penn\+OS)\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
-\/1 on error, 0 if cp was successful 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a494917a8ce36ad19470a2116e57a1bc3}\label{sys__call_8h_a494917a8ce36ad19470a2116e57a1bc3} 
\index{sys\_call.h@{sys\_call.h}!s\_cp\_to\_host@{s\_cp\_to\_host}}
\index{s\_cp\_to\_host@{s\_cp\_to\_host}!sys\_call.h@{sys\_call.h}}
...
s-\/function wrapper around k\+\_\+cp\+\_\+to\+\_\+host 


\begin{DoxyParams}{Parameters}
{\em source} & source filename to copy from (in Penn\+OS) \\
\hline
{\em host\+\_\+dest} & destination filename to copy into (on host device)\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
-\/1 on error, 0 if cp was successful 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_ad55b8ad7785acad109a35a819e415622}\label{sys__call_8h_ad55b8ad7785acad109a35a819e415622} 
\index{sys\_call.h@{sys\_call.h}!s\_cp\_within\_fat@{s\_cp\_within\_fat}}
\index{s\_cp\_within\_fat@{s\_cp\_within\_fat}!sys\_call.h@{sys\_call.h}}
...
s-\/function wrapper around k\+\_\+cp\+\_\+within\+\_\+fat. Copies contents of {\ttfamily source} to {\ttfamily dest}. {\ttfamily source} must exist, if {\ttfamily dest} doesn\textquotesingle{}t exist then it is created. 


\begin{DoxyParams}{Parameters}
{\em source} & source filename to copy from \\
\hline
{\em dest} & destination filename to copy into\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
-\/1 on error, 0 if cp was successful 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_ae8b8546b3350e1602c1574b1b0cb58d0}\label{sys__call_8h_ae8b8546b3350e1602c1574b1b0cb58d0} 
\index{sys\_call.h@{sys\_call.h}!s\_does\_file\_exist2@{s\_does\_file\_exist2}}
\index{s\_does\_file\_exist2@{s\_does\_file\_exist2}!sys\_call.h@{sys\_call.h}}
...
Wrapper function around k\+\_\+does\+\_\+file\+\_\+exst2. Change the timestamp of the file to the current time. 
...
This will set the process state to zombied, adjust its state within the scheduler structures, and kill all child proceseses. (not done). \Hypertarget{sys__call_8h_a31e11484cfd56821c3e9a1fa43aafcf0}\label{sys__call_8h_a31e11484cfd56821c3e9a1fa43aafcf0} 
...
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a2638b24106c052e0a513643f712e8d00}\label{sys__call_8h_a2638b24106c052e0a513643f712e8d00} 
\index{sys\_call.h@{sys\_call.h}!s\_get\_fname\_from\_fd@{s\_get\_fname\_from\_fd}}
\index{s\_get\_fname\_from\_fd@{s\_get\_fname\_from\_fd}!sys\_call.h@{sys\_call.h}}
...
Wrapper function around k\+\_\+get\+\_\+fname\+\_\+from\+\_\+fd. 
...
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a6f0dde68afa56241329a522dcf741dec}\label{sys__call_8h_a6f0dde68afa56241329a522dcf741dec} 
...
{\footnotesize\ttfamily int s\+\_\+ls (\begin{DoxyParamCaption}\item[{const char \texorpdfstring{$\ast$}{*}}]{filename,  }\item[{int}]{fd }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em filename} & Lists information about the specified file\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int (-\/1 on error) 
...
\begin{DoxyParams}{Parameters}
{\em fd} & The filedescriptor whose file pointer is to be moved \\
\hline
{\em offset} & The offset at which to move by (in bytes) \\
\hline
{\em whence} & Relative byte location to offset from\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
off\+\_\+t (-\/1 on error) 
...
\begin{DoxyParams}{Parameters}
{\em fname} & opens file with this name \\
\hline
{\em mode} & opens file in this mode\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int (-\/1 on error), on success returns fd number of opened file 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_adc34021a4da6a8e67a92d16e8adef872}\label{sys__call_8h_adc34021a4da6a8e67a92d16e8adef872} 
\index{sys\_call.h@{sys\_call.h}!s\_print\_jobs@{s\_print\_jobs}}
\index{s\_print\_jobs@{s\_print\_jobs}!sys\_call.h@{sys\_call.h}}
\doxysubsubsection{\texorpdfstring{s\_print\_jobs()}{s\_print\_jobs()}}
{\footnotesize\ttfamily int s\+\_\+print\+\_\+jobs (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
return int Returns 0 on success, -\/1 on failure and sets errno. \Hypertarget{sys__call_8h_a2e87f593f5c2f59d7a90958b3e51751d}\label{sys__call_8h_a2e87f593f5c2f59d7a90958b3e51751d} 
\index{sys\_call.h@{sys\_call.h}!s\_print\_process@{s\_print\_process}}
\index{s\_print\_process@{s\_print\_process}!sys\_call.h@{sys\_call.h}}
...
Prints all processes in processes, stopped, blocked, zombied. Used for \textquotesingle{}ps\textquotesingle{} command. 
...
\begin{DoxyParams}{Parameters}
{\em fd} & file descriptor to read from (from fd\textquotesingle{}s offset) \\
\hline
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
ssize\+\_\+t (-\/1 on error), 0 if EOF reached, otherwise number of bytes read 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a18b25be5ab040f60070ff9ea839648be}\label{sys__call_8h_a18b25be5ab040f60070ff9ea839648be} 
\index{sys\_call.h@{sys\_call.h}!s\_read\_all@{s\_read\_all}}
\index{s\_read\_all@{s\_read\_all}!sys\_call.h@{sys\_call.h}}
...
Wrapper function around k\+\_\+read\+\_\+all. 
...
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a964c6f7d6a06dddfd15cbd2d348dbd59}\label{sys__call_8h_a964c6f7d6a06dddfd15cbd2d348dbd59} 
\index{sys\_call.h@{sys\_call.h}!s\_reap\_all\_child@{s\_reap\_all\_child}}
\index{s\_reap\_all\_child@{s\_reap\_all\_child}!sys\_call.h@{sys\_call.h}}
...
int Returns 0 on success, -\/1 on failure and sets errno. 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_aeea2dcf94b9a35c86a67cf6ec97fd21d}\label{sys__call_8h_aeea2dcf94b9a35c86a67cf6ec97fd21d} 
\index{sys\_call.h@{sys\_call.h}!s\_rename@{s\_rename}}
\index{s\_rename@{s\_rename}!sys\_call.h@{sys\_call.h}}
...
s-\/function wrapper around k\+\_\+rename, which renames {\ttfamily source} to {\ttfamily dest}. {\ttfamily source} must exist, if {\ttfamily dest} already exists, then it is deleted 


\begin{DoxyParams}{Parameters}
{\em source} & name of the source file to be renamed \\
\hline
{\em dest} & new name of file\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
-\/1 on error, 0 if rename was successful 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_ac6d9cddaea840f87aee45bd6e6122acc}\label{sys__call_8h_ac6d9cddaea840f87aee45bd6e6122acc} 
\index{sys\_call.h@{sys\_call.h}!s\_resume\_block@{s\_resume\_block}}
\index{s\_resume\_block@{s\_resume\_block}!sys\_call.h@{sys\_call.h}}
\doxysubsubsection{\texorpdfstring{s\_resume\_block()}{s\_resume\_block()}}
{\footnotesize\ttfamily int s\+\_\+resume\+\_\+block (\begin{DoxyParamCaption}\item[{pid\+\_\+t}]{pid }\end{DoxyParamCaption})}
...
0 on success, -\/1 on error. 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_a0b8fdff50e5b9c5fa8559fe294e4243f}\label{sys__call_8h_a0b8fdff50e5b9c5fa8559fe294e4243f} 
...
This generalizes the control loop of spawning a process, waiting on it via s\+\_\+waitpid (depending on whether it was a background process) and then cleaning it up, into one function call. Used to call most shell functions (b\+\_\+functions).


\begin{DoxyParams}{Parameters}
{\em func} & The function to be executed. \\
\hline
{\em argv} & The argument to that function that is passed into the \doxylink{sys__call_8c_a43b789c710ba1501bcd8cf54e4382e50}{s\+\_\+spawn} call. \\
\hline
{\em fd0} & Input file descriptor. \\
\hline
{\em fd1} & Output file descriptor. \\
\hline
{\em nohang} & Whether or not to wait on the process or immediately proceed. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int Returns 0 on success, -\/1 on failure and sets errno.
...
removes the file specified by {\ttfamily fname} , {\ttfamily fname} must exist, returns -\/1 on error if it doesn\textquotesingle{}t 


\begin{DoxyParams}{Parameters}
{\em fname} & name of the file to be removed\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int (-\/1 on error) 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_ab40c873ca412b774e2fc1b59527538be}\label{sys__call_8h_ab40c873ca412b774e2fc1b59527538be} 
\index{sys\_call.h@{sys\_call.h}!s\_update\_timestamp@{s\_update\_timestamp}}
\index{s\_update\_timestamp@{s\_update\_timestamp}!sys\_call.h@{sys\_call.h}}
...
Wrapper function around k\+\_\+update\+\_\+timestamp. Returns the filename for the given file descriptor number. 


\begin{DoxyParams}{Parameters}
{\em source} & Soruce file name\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
int (-\/1 on error) 
...
\begin{DoxyParams}{Parameters}
{\em fd} & file descriptor to write to (from fd\textquotesingle{}s offset) \\
\hline
{\em str} & input string to be written \\
\hline
{\em n} & number of bytes to be written\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
ssize\+\_\+t (-\/1 on error), otherwise number of bytes written 
\end{DoxyReturn}
...
int Returns 0 on success, -\/1 on failure and sets errno. 
\end{DoxyReturn}
\Hypertarget{sys__call_8h_abf654a2582830ad3a5ce3db38c944f81}\label{sys__call_8h_abf654a2582830ad3a5ce3db38c944f81} 
\index{sys\_call.h@{sys\_call.h}!s\_zombie@{s\_zombie}}
\index{s\_zombie@{s\_zombie}!sys\_call.h@{sys\_call.h}}
\doxysubsubsection{\texorpdfstring{s\_zombie()}{s\_zombie()}}
{\footnotesize\ttfamily int s\+\_\+zombie (\begin{DoxyParamCaption}\item[{pid\+\_\+t}]{pid }\end{DoxyParamCaption})}
