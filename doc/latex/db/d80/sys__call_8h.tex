...
This function is analogous to {\ttfamily \doxylink{shellbuiltins_8h_acc8612feeec5f569b1e096e3110d0dca}{sleep(3)}} in Linux, with the behavior that the system clock continues to tick even if the call is interrupted. The sleep can be interrupted by a P\+\_\+\+SIGTERM signal, after which the function will return prematurely.
